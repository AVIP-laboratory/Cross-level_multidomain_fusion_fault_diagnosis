...
if job == 1:
    ...
    layer_X = Conv2D(16, (3, 3), padding="same", activation='relu')(feature_level_fusion)
    ...
    # Define the model
    model = Model(inputs=[Time_Input, FFT_Input, MFCC_Input], outputs=outputs)
    model.summary()
...
if job == 2:
    ...
    score = model.evaluate([Test_time_data, Test_FFT_data, Test_MFCC_data], Y_test, verbose=0)
    ...
    y_pred = model.predict([Test_time_data, Test_FFT_data, Test_MFCC_data])
